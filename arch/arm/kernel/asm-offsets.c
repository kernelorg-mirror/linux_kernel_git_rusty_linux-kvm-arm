...
int main(void)
{
  ...
  DEFINE(VCPU_TIMER_CNTVOFF_H,	offsetof(struct kvm_vcpu, arch.timer_cpu.cntvoff_high));
  DEFINE(VCPU_TIMER_CNTVOFF_L,	offsetof(struct kvm_vcpu, arch.timer_cpu.cntvoff_low));
